...
public class AdminEditPjActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_editpj);
        ...
        btnStartTime.setText(project.getStartTime());
        btnEndTime.setText(project.getEndTime());
        btnSelectAddress.setText(project.getAddress());
        etContent.setText(project.getContent());
        etNumber.setText(String.valueOf(project.getNumber()));
        etTelephone.setText(project.getTelephone());
        btnPicture.setText(project.getPicture());
        ...
        btnSelectAddress.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MapHelper.startMapActivity(AdminEditPjActivity.this);
            }
        });
        ...
        btnEditProject.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                boolean isValid = ProjectValidator.validateProject(AdminEditPjActivity.this, name, startTime, endTime, address, content, numberString,telephone);
                ...
                if (isValid) {
                    ...
                    project.setNumber(Integer.parseInt(numberString));
                    project.setTelephone(telephone);

                    // Call the appropriate service method to update the project in the database
                    ProjectService.getInstance(getApplicationContext()).updateProject(project);

                    // Show success message and return to previous activity
                    Toast.makeText(AdminEditPjActivity.this, "项目修改成功", Toast.LENGTH_SHORT).show();
                    finish();
                }
            }
        });
    ...
    private void showDateTimePicker(final Calendar calendar, final boolean isStartTime) {
        DateTimeHelper.showDateTimePicker(AdminEditPjActivity.this, calendar, new DateTimeHelper.DateTimeListener() {
            @Override
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_GALLERY_IMAGE && resultCode == RESULT_OK) {
            ...
            // 在这里处理选择的图片
            String imagePath = ImageUtils.saveImageToLocal(AdminEditPjActivity.this,imageUri); // 保存图片到本地
