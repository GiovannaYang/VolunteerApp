...
import com.example.volunteerapp.Activity.Project.ProjectAdapter;
...
public class JoinAdapter extends BaseAdapter {
    ...
    public void setJoins(List<Project> projects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            viewHolder = (JoinAdapter.ViewHolder) convertView.getTag();
        }
        ...
        Glide.with(context)
                ...
                .transform(new CenterCrop(), new JoinAdapter.ImageCropTransformation()) // 使用CenterCrop和自定义裁剪Transformation
